...
- not all experimental data can fit seamlessly into a normal numpy array
    ...
    - often have different number of data points for different subjects/trials, which requires multiple arrays, each of different length
...
- see [course website](http://scipycourse2021.github.io) for two different pandas cheat sheets
